...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_timeout(3000)
        await elem.fill(
            "This project is for testing ChatInterface message history and input handling."
        )
        ...
        elem = frame.locator("xpath=html/body/main/div/div[2]/form/div[2]/textarea").nth(0)
        await page.wait_for_timeout(3000)
        await elem.fill("This project tests ChatInterface message history and input handling.")
        ...
        elem = frame.locator("xpath=html/body/main/div/div[2]/form/div/input").nth(0)
        await page.wait_for_timeout(3000)
        await elem.fill("myawesomeproject123")
        ...
        try:
            await expect(
                frame.locator("text=Message history loaded successfully").first
            ).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError(
                "Test case failed: The ChatInterface did not display message history, handle user input, or show agent status as expected according to the test plan."
            )
