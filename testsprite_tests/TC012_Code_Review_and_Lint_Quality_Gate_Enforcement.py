...
async def run_test():
    ...
    try:
        ...
        await elem.fill(
            "This project will test that agents cannot mark tasks complete unless all testing, linting, and review quality gates pass as per policy."
        )
        ...
        elem = frame.locator("xpath=html/body/main/div/div[2]/form/div[2]/textarea").nth(0)
        await page.wait_for_timeout(3000)
        await elem.fill("Test project for validating task completion quality gates.")
        ...
        try:
            ...
            raise AssertionError(
                "Test failed: Agents should not be able to mark tasks complete unless all testing, linting, and review quality gates pass as per policy, and auto-correction loops must trigger as needed."
            )
