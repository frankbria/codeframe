...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_timeout(3000); await elem.fill('This project is for testing task tree with issues and nested tasks.')
        ...
        try:
            ...
            raise AssertionError("Test plan execution failed: Issues and nested tasks are not displayed correctly in the task tree with collapsible views and status badges.")
