...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_timeout(3000)
        await elem.fill("This is a test project to verify task tree functionality.")
        ...
        await page.wait_for_timeout(3000)
        await elem.fill(
            "This project verifies task tree display with nested tasks and status badges."
        )
        ...
        elem = frame.locator("xpath=html/body/main/div/div[2]/form/div/input").nth(0)
        await page.wait_for_timeout(3000)
        await elem.fill("testproject123")

        frame = context.pages[-1]
        # Fill description with at least 10 characters
        elem = frame.locator("xpath=html/body/main/div/div[2]/form/div[2]/textarea").nth(0)
        await page.wait_for_timeout(3000)
        await elem.fill("Testing task tree display with nested tasks and status badges.")
        ...
        try:
            ...
            raise AssertionError(
                "Test plan failed: The task tree did not display nested tasks with collapsible views and status badges as expected."
            )
