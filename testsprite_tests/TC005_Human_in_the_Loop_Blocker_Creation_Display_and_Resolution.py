...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_timeout(3000); await elem.fill('This project is for testing blocker system with SYNC and ASYNC priorities.')
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Blocker Priority: IMMEDIATE').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test plan execution failed: Blocker system did not support creation with SYNC/ASYNC priorities, display blockers correctly, or allow resolution to unblock agent progress.")
