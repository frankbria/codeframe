...
class TestDiscoveryProgressEndpoint:
    ...
    def test_get_discovery_progress_returns_404_for_nonexistent_project(self, api_client):
        """Test endpoint returns 404 for non-existent project."""
        # ACT
        response = api_client.get("/api/projects/99999/discovery/progress")
    ...
    def test_get_discovery_progress_returns_null_when_discovery_not_started(
        ...
        # ACT
        response = api_client.get(f"/api/projects/{project_id}/discovery/progress")
    ...
    @patch("codeframe.agents.lead_agent.AnthropicProvider")
    def test_get_discovery_progress_matches_project_phase(self, mock_provider_class, api_client):
    ...
    @patch("codeframe.agents.lead_agent.AnthropicProvider")
    def test_get_discovery_progress_excludes_answers_field(self, mock_provider_class, api_client):
