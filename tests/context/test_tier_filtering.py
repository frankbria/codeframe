...
class TestTierFiltering:
    ...
    def test_filter_by_hot_tier(self, temp_db, test_project):
        ...
        # HOT items (score >= 0.8)
        hot_item_1 = temp_db.create_context_item(project_id=test_project, agent_id=agent_id,
        ...
        warm_item = temp_db.create_context_item(project_id=test_project, agent_id=agent_id,
        ...
        hot_items = temp_db.list_context_items(project_id=test_project, agent_id=agent_id, tier="HOT")
    ...
    def test_filter_by_warm_tier(self, temp_db, test_project):
        ...
        # Create HOT item
        hot_item = temp_db.create_context_item(project_id=test_project, agent_id=agent_id,
            item_type=ContextItemType.TASK.value,
        ...
        # Create WARM items
        warm_item_1 = temp_db.create_context_item(project_id=test_project, agent_id=agent_id,
            item_type=ContextItemType.CODE.value,
            content="Some code"
        )
        cursor.execute(
        ...
        warm_item_2 = temp_db.create_context_item(project_id=test_project, agent_id=agent_id,
        ...
        warm_items = temp_db.list_context_items(project_id=test_project, agent_id=agent_id, tier="WARM")
    ...
    def test_filter_by_cold_tier(self, temp_db, test_project):
        ...
        # Create COLD item
        cold_item = temp_db.create_context_item(project_id=test_project, agent_id=agent_id,
        ...
        cold_items = temp_db.list_context_items(project_id=test_project, agent_id=agent_id, tier="COLD")
    ...
    def test_tier_none_returns_all_items(self, temp_db, test_project):
        ...
        all_items = temp_db.list_context_items(project_id=test_project, agent_id=agent_id, tier=None)
