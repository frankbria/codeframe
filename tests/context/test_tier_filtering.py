...
class TestTierFiltering:
    ...
    def test_filter_by_hot_tier(self, temp_db):
        ...
        hot_items = temp_db.list_context_items(agent_id=agent_id, tier="HOT")
    ...
    def test_filter_by_warm_tier(self, temp_db):
        ...
        warm_items = temp_db.list_context_items(agent_id=agent_id, tier="WARM")
    ...
    def test_filter_by_cold_tier(self, temp_db):
        ...
        cold_items = temp_db.list_context_items(agent_id=agent_id, tier="COLD")
    ...
    def test_tier_none_returns_all_items(self, temp_db):
        ...
        all_items = temp_db.list_context_items(agent_id=agent_id, tier=None)
    ...
    def test_empty_tier_filter(self, temp_db):
