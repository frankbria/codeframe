      ...
      <CardContent>
        ...
        {isOpen && !collapsed && (
          <div data-testid="blocker-answer-form">
            <textarea
              className="mb-2 w-full rounded-md border bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus:outline-hidden focus:ring-2 focus:ring-ring disabled:opacity-50"
              rows={3}
