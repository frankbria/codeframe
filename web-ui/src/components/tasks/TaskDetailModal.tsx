                  ...
                  {task.depends_on.map((depId) => {
                    ...
                    return (
                      <li key={depId} className="flex items-center gap-2 text-xs">
                        ...
                        {onOpenTask ? (
                          <button
                            className={`truncate text-left hover:underline focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:ring-ring ${isIncomplete ? 'font-medium text-amber-700 dark:text-amber-400' : 'text-foreground'}`}
