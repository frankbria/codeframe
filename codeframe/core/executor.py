...
# Re-exported from a stdlib-only leaf module so the claude-code guard can
# import the patterns without dragging in the LLM SDKs on every Bash call
# it vets. Single source of truth lives there. (#819 review)
from codeframe.core.dangerous_commands import (  # noqa: F401
    DANGEROUS_PATTERNS,
